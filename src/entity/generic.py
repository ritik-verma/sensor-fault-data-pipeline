...
class Generic:
    ...
    def __init__(self, record: dict):
        for k, v in record.items():         #contains the key-value pairs of the dictionary, as tuples in a list.
            setattr(self, k, v)             #The setattr() function sets the value of the attribute of an object.
    ...
    def to_dict(self):
        return self.__dict__               #The mapping of attributes with its values is done to generate a dictionary.
